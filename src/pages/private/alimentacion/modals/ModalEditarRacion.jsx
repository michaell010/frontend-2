// src/pages/private/alimentacion/modals/ModalEditarRacion.jsx
      ...
      <div className="al-modal">
        <div className="al-modal__header">
          <div>
            ...
            <div className="al-modal__subtitle" style={{ fontFamily: "monospace", fontSize: "0.72rem" }}>
              ID #{registro.id} · {registro.animal?.nombre || `Animal ${registro.animal_id}`}
            </div>
          </div>
