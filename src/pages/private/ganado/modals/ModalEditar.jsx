...
export default function ModalEditar({ animal, onClose, onGuardar }) {
  const [form, setForm] = useState({
    ...animal,
    peso_actual: animal?.peso_actual ?? animal?.peso ?? "",
    observaciones: animal?.observaciones ?? animal?.notas ?? "",
    foto: null,
    foto_preview: animal?.foto || "",
  });
    ...
    <div className="gc-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="gc-modal">
        <div className="gc-modal__header">
          <div>
            <div className="gc-modal__title">Editar Animal</div>
            <div
